...
## 📁 Parte 1 — Lógica de Programação (`/logica-de-programacao`)
...
## 📁 Parte 2 — Programação Orientada a Objetos (`/orientacao-a-objetos`)
...
Desenvolvido por **Isla** durante seus estudos de Python — do primeiro contato com lógica de programação até a aplicação de Orientação a Objetos e consumo/criação de APIs.
